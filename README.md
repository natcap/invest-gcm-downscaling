...
## Usage
1.	First, install this plugin. The easiest way to do this is via the InVEST Workbench (version 3.18.0 or later). You can download and install this plugin using its git URL (https://github.com/natcap/invest-gcm-downscaling.git), or, if you prefer, you can clone this repo to your computer and then install it using the path to your local copy.
